import { MASK_NODE, MASK_RESERVED, MASK_SEQUENCE, MASK_TIMESTAMP, MAX_NODE, MAX_SEQUENCE, MAX_TIMESTAMP, OFFSET_NODE, OFFSET_RESERVED, OFFSET_SEQUENCE, OFFSET_TIMESTAMP, RESERVED } from '../src/constants.js';
